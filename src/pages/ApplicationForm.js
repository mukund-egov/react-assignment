...
function ApplicationForm() {
  ...
  return (
    <div className="justify-center flex w-full">
      <div className="shadow-lg rounded-lg p-6 w-full md:w-2/3 h-auto justify-center sm:mr-10 sm:ml-10 mt-4 ">
        <h1 className="text-3xl pb-4 mb-10 mt-3 font-sans font-bold">
          Application Form
        </h1>
        <div className="flex justify-center h-auto">
          <form
            className="sm:w-1/2 justify-center"
            onSubmit={handleSubmit(onSubmit)}
          >
            {/* Name */}
            <div className="flex md:flex-row flex-col  mb-4 text-center">
              <label className="text-lg font-medium mb-2 sm:mr-6 w-40">
                Name
              </label>
              <input
                type="text"
